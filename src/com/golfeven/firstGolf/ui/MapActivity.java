...
import com.golfeven.firstGolf.common.BMapUtil;
...
public class MapActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBMapManager = BMapUtil.getInstance(getApplicationContext()).mBMapManager;
		...
		mMapView.getController().setCenter(stPoint);
